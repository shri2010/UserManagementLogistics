...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">user-management-logistics documentation</a>
                </li>
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/UserDataServiceService.html" data-type="entity-link">UserDataServiceService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
